...
int main() {
    ...
    // Start RTSP stream
    std::string pipeline_description = "( testsrc ! video/x-h264,width=1280,height=720,framerate=30/1 ! h264parse ! rtph264pay name=pay0 pt=96 )";
    rtsp_streamer.start_stream("/omegabot_stream", pipeline_description);
