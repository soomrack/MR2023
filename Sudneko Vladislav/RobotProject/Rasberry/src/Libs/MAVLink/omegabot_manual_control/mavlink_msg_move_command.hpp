// MESSAGE MOVE_COMMAND support class
...
/**
 * @brief MOVE_COMMAND message
 *
 * Manual Control Omegabot
 */
struct MOVE_COMMAND : mavlink::Message {
    static constexpr msgid_t MSG_ID = 1;
    static constexpr size_t LENGTH = 1;
    static constexpr size_t MIN_LENGTH = 1;
    static constexpr uint8_t CRC_EXTRA = 197;
    static constexpr auto NAME = "MOVE_COMMAND";
