...
void monthOperation(Capital * this, int monthNum);  // monthly routine, calculate capital changes every month 
double calcBobApartmentFee(long debt, __uint8_t percent);  //  function calculate Bob's mortgage monthly fee
long int processFunction(Capital * this, int totalMonthNum); // main process function with lopp
