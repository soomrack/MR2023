...
kopeyki amortization = 5000 * 100;//monthly contribution for "airbag"(treatment, technique breakdown)
...
struct Person {
    kopeyki capital;
    kopeyki salary;
    kopeyki expenses;//includes homehold, clothes, food expenses etc.
    kopeyki rent_price;
