...
void plant_orange()  // состояние среды подходящее для апельсина
{
clim.min_light = 450;
  clim.min_temp = 40;
  clim.max_temp = 60;
...
void set_plant()  // устанавливает тип растения
{
  ...
  switch(plant_type){
    ...
    case 2: plant_repka(); break;
    case 3: plant_orange(); break;
...
void plant_repka()       // состояние среды подходящее для капусты
{ 
  clim.min_light = 300;
  clim.min_temp = 40;
  clim.max_temp = 45;
...
void plant_orange()  // состояние среды подходящее для арбуза
{
clim.min_light = 450;
  clim.min_temp = 40;
  clim.max_temp = 60;
